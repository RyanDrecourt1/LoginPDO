...
class PDOdataBase	
{
    ...
    public function connect()    {
        if ( null == $this->handler )        
		{
            try{
				...
				return true		;	// rÃ©ussite de la connexion
            }
            catch(PDOException $e) {
                $this->error =	$e->getMessage();
				return false	;	// echec Ã  la connexion
            }
        }        
    }
	...
	//Value is the actual value that we want to bind to the placeholder, example â€œJohn Smithâ€.
